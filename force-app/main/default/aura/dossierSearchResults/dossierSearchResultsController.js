({
    ...
    onSelect : function(component, event, helper) {
        ...
        for (var i = 0; i < results.length; i++) {
            if ((results[i].get('v.result').dossier_number !== params.DossierNumber && results[i].get('v.result').establishment_number !== params.EstablishmentNumber) || results[i].get('v.result').creditSafeId !== params.creditSafeId) {

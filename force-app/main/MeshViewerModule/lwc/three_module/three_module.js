...
// export { LightShadowAmbientLight } from './lights/LightShadow.js';
...
export { OrbitControls } from './plugins/jsm/controls/OrbitControls.js';
export { TransformControls } from './plugins/jsm/controls/TransformControls.js';
export { FirstPersonControls } from './plugins/jsm/controls/FirstPersonControls.js';

export { OBJLoader } from './plugins/jsm/loaders/OBJLoader.js';
export { MTLLoader } from './plugins/jsm/loaders/MTLLoader.js';
export { DDSLoader } from './plugins/jsm/loaders/DDSLoader.js';

export { Sky } from './plugins/jsm/objects/Sky.js';
